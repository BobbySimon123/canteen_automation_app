...
Widget formField(context, hint,
  ...
  return TextFormField(
    ...
    decoration: InputDecoration(
      ...
      hintText: hint,
      hintStyle: TextStyle(fontSize: 14.0, color: Color(0xFF838591)),
      prefixIcon: Icon(
        prefixIcon,
    ...
    style: TextStyle(
        fontSize: 20.0,
        color: isDummy ? Colors.transparent : Color(0xFF1e253a),
        fontFamily: 'Regular'),
  );
}
...
BoxDecoration boxDecoration4(
  ...
  return BoxDecoration(
    color: bgColor,
    boxShadow: showShadow
        ? [BoxShadow(color: Color(0X95E9EBF0), blurRadius: 6, spreadRadius: 2)]
        : [BoxShadow(color: Colors.transparent)],
    border: Border.all(color: color),
    borderRadius: BorderRadius.all(Radius.circular(radius)),
  );
...
BoxDecoration gradientBoxDecoration(
    {double radius = 10.0,
    Color color = Colors.transparent,
    Color gradientColor2 = const Color(0xFFffffff),
    Color gradientColor1 = const Color(0xFFffffff),
    var showShadow = false}) {
  return BoxDecoration(
        ...
        GestureDetector(
            ...
            child: Align(
              ...
              child: Container(
                ...
                height: width * 0.1,
                decoration:
                    mobile(showShadow: false, bgColor: Color(0xFF494FFB)),
