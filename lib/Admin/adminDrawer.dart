            ...
            child: Column(
              children: <Widget>[
                ...
                getDrawerItem(Icons.article, "All Orders", 2,
                    tags: AllOrdersScreen()),
                Padding(
                  padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                  child: Divider(color: Color(0XFFDADADA), height: 1),
                ),
                getDrawerItem(Icons.article, "Add FoodItem", 3,
                    tags: AddProduct()),
                Padding(
                  padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                  child: Divider(color: Color(0XFFDADADA), height: 1),
                ),
                getDrawerItem(Icons.food_bank_sharp, "All Categories", 4,
                    tags: AllCat()),
                Padding(
                  padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                  child: Divider(color: Color(0XFFDADADA), height: 1),
                ...
                getDrawerItem(Icons.feedback, "Feedbacks", 6,
                    tags: DisplayFeedback()),
                Padding(
                  padding: const EdgeInsets.only(left: 15.0, right: 15.0),
                  child: Divider(color: Color(0XFFDADADA), height: 1),
                ),
